        ...
        <div class="sisme-submit-game-section">
            ...
            <div class="sisme-submit-game-content">
                <form id="sisme-submit-game-form" class="sisme-submit-game-form" method="post">
                    ...
                    <script>
                    // Code SimpleCropper directement ici pour tester
                    class SimpleCropper {
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        console.log('DOM loaded, Cropper available:', typeof Cropper !== 'undefined');
                        
                        if (typeof Cropper !== 'undefined' && document.getElementById('simpleCropTest')) {
                            console.log('Initialisation SimpleCropper...');
                            new SimpleCropper('simpleCropTest');
                        } else {
                            console.error('Cropper.js non chargé ou élément introuvable');
                        }
                    });
                    </script>
